...
const RestaurantInfo = () => {
  ...
  <div className="card-body text-center p-12">
    ...
    <p>Spi & Savory" is a vibrant restaurant blending rich, aromatic spices with fresh ingredients to create globally inspired, flavorful dishes. Known htmlFor its cozy ambiance and attentive service, it's the perfect spot htmlFor food enthusiasts seeking a memorable dining experience. Indulge in a menu that celebrates both classic and innovative flavors.</p>
  </div>
</div>
        </div>
    );
