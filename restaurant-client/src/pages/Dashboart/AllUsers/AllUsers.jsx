                        ...
                        <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                {data?.map((item, index) => (
                                    ...
                                    <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                        { item.role === 'admin' ? 'admin' : <FaUsers onClick={() => handleMakeAdmin(item)} className='w-6 h-6' />}
                                    </td>
                                    <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                        <button onClick={() => handleUsersDelete(item._id)}  className="text-white bg-red-800 p-2 rounded-lg transition-colors duration-200 dark:hover:text-red-500 dark:text-gray-300 focus:outline-none">
                                        <svg
